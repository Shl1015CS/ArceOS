...
impl From<NetError> for AxError {
    fn from(err: NetError) -> Self {
        match err {
            ...
            NetError::AddrNotAvailable => AxError::AddrNotAvailable,
            NetError::NetworkUnreachable => AxError::NetworkUnreachable,
            NetError::HostUnreachable => AxError::HostUnreachable,
...
impl From<AxError> for NetError {
    fn from(err: AxError) -> Self {
        match err {
            ...
            AxError::AddrNotAvailable => NetError::AddrNotAvailable,
            AxError::NetworkUnreachable => NetError::NetworkUnreachable,
            AxError::HostUnreachable => NetError::HostUnreachable,
